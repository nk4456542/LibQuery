...
from library.models import BookInstance, Book, Genre, Language, Author
...
class LoanedBookInstancesByUserListViewTest(TestCase):
    ...
    def test_redirect_if_not_logged_in(self):
        ...
        self.assertRedirects(
            response, '/accounts/login/?next=/library/mybooks/')
    ...
    def test_logged_in_uses_correct_template(self):
        ...
        self.assertTemplateUsed(
            response, 'library/bookinstance_list_borrowed_user.html')
...
class AuthorCreateViewTest(TestCase):
    ...
    def test_redirect_if_not_logged_in(self):
        ...
        self.assertRedirects(
            response, '/accounts/login/?next=/library/author/create/')
    ...
    #     self.assertEqual(response.status_code, 302)
    #     self.assertTrue(response.url.startswith('/library/author/'))
